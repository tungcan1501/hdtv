 ...
 */
function abshop_preprocess_page(&$variables) {
    drupal_add_js(drupal_get_path('theme', 'abshop') . "/js/abshop.js");
...
function abshop_preprocess_node(&$variables) {
...
function abshop_form_alter(&$form, &$form_state, $form_id) {
